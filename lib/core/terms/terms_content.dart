/// The canonical text of NEEDLIX's Terms of Service and Privacy Policy.
...
Terms of Service for NEEDLIX
Last Updated: Feb 22, 2026

1. Acceptance of Terms
By accessing or using the NEEDLIX mobile application, you agree to be bound by these Terms of Service. If you disagree with any part of the terms, you may not access the service.

2. Description of Service
NEEDLIX is a business management tool designed for tailors and fashion designers to manage customer measurements, track orders, generate invoices, and monitor business analytics.
...
NEEDLIX may offer both Free (Freemium) and Premium subscription tiers.
...
You retain all your ownership rights to the customer data, measurements, and images you upload to NEEDLIX. By uploading content, you grant us a license to host, store, and display that data solely for the purpose of providing the NEEDLIX service to you.

6. Acceptable Use
You agree not to use NEEDLIX to:
...
NEEDLIX is provided on an "AS IS" and "AS AVAILABLE" basis. We shall not be liable for any indirect, incidental, or consequential damages, including but not limited to loss of data, loss of revenue, or business interruption resulting from the use or inability to use the app.

8. Termination
We may terminate or suspend your account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms.

9. Contact Us
For any questions regarding these Terms, please contact us at: NEEDLIX@gmail.com
''';

const String kPrivacyPolicy = '''
Privacy Policy for NEEDLIX
Last Updated: Mar 22, 2026

1. Introduction
Welcome to NEEDLIX ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. This Privacy Policy governs the data collection and usage of the NEEDLIX mobile application and related services.
...
• Provide, operate, and maintain the NEEDLIX app.
...
6. Contact Us
If you have questions or comments about this notice, you may email us at: NEEDLIX@gmail.com
''';
